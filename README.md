...
<img src="./SS/LabArch.png" alt="drawing" width="600">
...
3. Enter the following:
    ...
    7. ⚠️ SAVE ADMIN user & Password for later use ⚠️
    8. **Access type:** Secure access from allowed IPs and VCNs only
    9. Set **IP notation type:** CIDR block & **Value:** 0.0.0.0/0 - ⚠️**For testing purpose only**⚠️
    10. Skip on the **Contacts** section and click **Create**
...
12. Copy the following SQL command to the worksheet to create new JSON DB with Mongo compability and run
